...
public class listaContenido extends AppCompatActivity {
    private Button b1,b2;
    private MediaPlayer mediaPlayer;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_lista_contenido);
        ...
        String recuperamos_variable_string3 = getIntent().getStringExtra("cancion");
        ...
        int soundId = res.getIdentifier(recuperamos_variable_string3, "raw", this.getPackageName());
